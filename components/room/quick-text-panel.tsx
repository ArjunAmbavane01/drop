...
export function QuickTextPanel({
  ...
  return (
    <div className="flex flex-col flex-1 h-full min-h-0">
      ...
      <div className="flex-1 flex flex-col rounded-xl border border-border/70 bg-card/30 dark:bg-card/15 focus-within:border-foreground/25 focus-within:ring-1 focus-within:ring-foreground/10 transition-all h-[60vh] sm:h-[68vh] md:h-[75vh] max-h-[calc(100vh-180px)] min-h-[480px] overflow-hidden">
        <textarea
          value={value}
